      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          <motion.div
            ...
            className="md:hidden max-w-1440 mx-auto px-4 mt-2 overflow-hidden"
          >
            <div className="p-6 rounded-2xl bg-surface/95 backdrop-blur-2xl border border-white/10 shadow-2xl space-y-4">
